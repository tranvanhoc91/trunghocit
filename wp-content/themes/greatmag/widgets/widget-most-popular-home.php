		...
		<div class="post-by-cats boxed-pbc style2">
			...
			<div class="pbc-carousel">
				...
				<?php while ( $r->have_posts() ) : $r->the_post(); ?>
					...
					<?php $meta = '<h5 class="post-meta"><a href="' . get_author_posts_url( get_the_author_meta( 'ID' ) ) . '" class="author">' . esc_html( get_the_author() ) . '</a>  -  <a href="' . get_the_permalink() . '" class="date">' . esc_html( get_the_date() ) . '</a></h5>'; ?>				
